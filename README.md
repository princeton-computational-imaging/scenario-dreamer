...
- [ ] [ETA: 07/31/2025] Support generation of large simulation environments
- [ ] [ETA: 07/31/2025] Support evaluation of Scenario Dreamer model on Waymo
- [ ] [ETA: 07/31/2025] Compatibility with nuPlan dataset
